-- ============================================
-- Local PostgreSQL Table Initialization
-- Execute this AFTER creating quiz_system database
-- Run with: psql -U postgres -d quiz_system -f database\init_local_tables.sql
-- ============================================
...
CREATE TABLE quiz_attempts (
    id SERIAL PRIMARY KEY,
    quiz_instance_id VARCHAR(100) UNIQUE,  -- String-based session ID like "QUIZ-1761796705275"
...
CREATE TABLE violations (
    id SERIAL PRIMARY KEY,
    quiz_id VARCHAR(100),  -- Changed to VARCHAR to support string quiz IDs like "QUIZ-1761796705275"
